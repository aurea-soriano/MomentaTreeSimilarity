...
class StandardMeanSquaredError:
    ...
    def calculate(self,  dense_vector1, dense_vector2):
        vector1 = self.standardize_data(dense_vector1.values)
        vector2 = self.standardize_data(dense_vector2.values)
...
def main():
    abstract_dissimilarity = StandardMeanSquaredError()
